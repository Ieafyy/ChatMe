    ...
    if (isOpen) return (
        <div className="fixed inset-0 z-10 flex items-center justify-center bg-gray-400 bg-opacity-50">
            <div className="bg-white text-black px-20 py-8 rounded-xl border-2 border-black text-center">
                ...
                <select onMouseEnter={getModels} onClick={getModels} id="dropdown" value={actualModel} onChange={handleChange} className="border-2 border-black text-xl mx-5 rounded-xl py-2 px-2 bg-slate-200">
